  ...
  return (
    <div
      ...
      className={cn(
        ...
        // Ganti white → #0A0F1A (background color) agar tidak putih
        'before:content-[""] before:absolute before:top-1/2 before:left-1/2 before:block before:size-[140%] before:[background:radial-gradient(ellipse_at_50%_55%,transparent_10%,#0A0F1A_50%)] before:[transform:translate3d(-50%,-50%,0)]',
        // after: kurangi opacity, ganti purple ke biru yang lebih sesuai palette
        'after:content-[""] after:absolute after:z-[5] after:top-1/2 after:left-1/2 after:block after:size-full after:[background:radial-gradient(ellipse_at_50%_75%,#1D4ED840_20%,transparent_75%)] after:[transform:translate3d(-50%,-50%,0)] after:mix-blend-overlay',
        className,
      )}
      {...props}
    >
      ...
      <canvas
        ref={canvasRef}
        className="absolute inset-0 block size-full opacity-30"
      />
      <motion.div
        className={cn(
          ...
          'dark:[background:linear-gradient(20deg,#006CF8,#ffbd1e20_16.5%,#1D038F_33%,#02536120_49.5%,#2102AD_66%,#0033C060_85.5%,#00318B_100%)_0_100%_/_100%_200%] ',
        )}
